...
fun Int.getBitsSlice(startIndex: Int, stopIndex: Int): Int = IntegerUtil.getBitsSlice(this, startIndex, stopIndex)

fun Int.getBitsSliceSafe(startIndex: Int, stopIndex: Int) : Int = IntegerUtil.getBitsSliceSafe(this, startIndex, stopIndex)

fun Int.setBitsSlice(startIndex: Int, stopIndex: Int) : Int = IntegerUtil.setBitsSlice(this, startIndex, stopIndex)

fun Int.setBitsSliceSafe(startIndex: Int, stopIndex: Int) : Int = IntegerUtil.setBitsSliceSafe(this, startIndex, stopIndex)

fun Int.clearBitsSlice(startIndex: Int, stopIndex: Int) : Int = IntegerUtil.clearBitsSlice(this, startIndex, stopIndex)

fun Int.clearBitsSliceSafe(startIndex: Int, stopIndex: Int) : Int = IntegerUtil.clearBitsSliceSafe(this, startIndex, stopIndex)
...
fun Int.clearHighBytes(numBytesToLeave: Int) : Int = IntegerUtil.clearHighBytes(this, numBytesToLeave)

fun Int.clearHighBytesSafe(numBytesToLeave: Int) : Int = IntegerUtil.clearHighBytesSafe(this, numBytesToLeave)
...
fun Long.getBitsSlice(startIndex: Int, stopIndex: Int) : Long = LongUtil.getBitsSlice(this, startIndex, stopIndex)

fun Long.getBitsSliceSafe(startIndex: Int, stopIndex: Int) : Long = LongUtil.getBitsSliceSafe(this, startIndex, stopIndex)

fun Long.setBitsSlice(startIndex: Int, stopIndex: Int) : Long = LongUtil.setBitsSlice(this, startIndex, stopIndex)

fun Long.setBitsSliceSafe(startIndex: Int, stopIndex: Int) : Long = LongUtil.setBitsSliceSafe(this, startIndex, stopIndex)

fun Long.clearBitsSlice(startIndex: Int, stopIndex: Int) : Long = LongUtil.clearBitsSlice(this, startIndex, stopIndex)

fun Long.clearBitsSliceSafe(startIndex: Int, stopIndex: Int) : Long = LongUtil.clearBitsSliceSafe(this, startIndex, stopIndex)
...
fun Long.clearHighBytes(numBytesToLeave: Int) : Long = LongUtil.clearHighBytes(this, numBytesToLeave)

fun Long.clearHighBytesSafe(numBytesToLeave: Int) : Long = LongUtil.clearHighBytesSafe(this, numBytesToLeave)
...
fun Short.getBitsSlice(startIndex: Int, stopIndex: Int) : Short = ShortUtil.getBitsSlice(this, startIndex, stopIndex)

fun Short.getBitsSliceSafe(startIndex: Int, stopIndex: Int) : Short = ShortUtil.getBitsSliceSafe(this, startIndex, stopIndex)

fun Short.setBitsSlice(startIndex: Int, stopIndex: Int) : Short = ShortUtil.setBitsSlice(this, startIndex, stopIndex)

fun Short.setBitsSliceSafe(startIndex: Int, stopIndex: Int) : Short = ShortUtil.setBitsSliceSafe(this, startIndex, stopIndex)

fun Short.clearBitsSlice(startIndex: Int, stopIndex: Int) : Short = ShortUtil.clearBitsSlice(this, startIndex, stopIndex)
...
fun Short.clearHighBytes(numBytesToLeave: Int) : Short = ShortUtil.clearHighBytes(this, numBytesToLeave)

fun Short.clearHighBytesSafe(numBytesToLeave: Int) : Short = ShortUtil.clearHighBytesSafe(this, numBytesToLeave)
